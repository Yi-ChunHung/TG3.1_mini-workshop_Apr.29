...
Dis     = [0 0 0.0;];
isVASP  = 1;
nvec    = [norm(vec1) norm(vec2) norm(vec3)];
[~,I]   = sort(nvec,'descend');
...
if isSlab
    save slab_info.mat orbitps sporbitps sptable atomps BR NBR U2STR isSlab num_layer
else
    save slab_info.mat orbitps sporbitps sptable atomps BR NBR U2STR isSlab
end