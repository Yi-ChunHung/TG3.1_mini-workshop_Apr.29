...
dCxCy 	= (1/2)*[[1 1 0];[1 -1 0];[-1 1 0];[-1 -1 0]];
dCyCz 	= (1/2)*[[0 1 1];[0 -1 1];[0 1 -1];[0 -1 -1]];
dCxCz 	= (1/2)*[[1 0 1];[1 0 -1];[-1 0 1];[-1 0 -1]];
...
dCxSy_p	= (1/2)*[[1 1 0];[-1 1 0]];
dCxSy_n = (1/2)*[[1 -1 0];[-1 -1 0]];
dCySz_p = (1/2)*[[0 1 1];[0 -1 1]];
dCySz_n = (1/2)*[[0 1 -1];[0 -1 -1]];
dCzSx_p = (1/2)*[[1 0 1];[1 0 -1]];
dCzSx_n = (1/2)*[[-1 0 1];[-1 0 -1]];
...
dSxSy_p	= (1/2)*[[1 1 0];[-1 -1 0]];
dSxSy_n = (1/2)*[[1 -1 0];[-1 1 0]];
dSySz_p	= (1/2)*[[0 1 1];[0 -1 -1]];
dSySz_n = (1/2)*[[0 -1 1];[0 1 -1]];
dSxSz_p	= (1/2)*[[1 0 1];[-1 0 -1]];
dSxSz_n = (1/2)*[[1 0 -1];[-1 0 1]];
...
dSxCy_p = (1/2)*[[1 1 0];[1 -1 0]];
dSxCy_n = (1/2)*[[-1 1 0];[-1 -1 0]];
dSyCz_p = (1/2)*[[0 1 1];[0 1 -1]];
dSyCz_n = (1/2)*[[0 -1 1];[0 -1 -1]];
dSzCx_p = (1/2)*[[1 0 1];[-1 0 1]];
dSzCx_n = (1/2)*[[1 0 -1];[-1 0 -1]];
...
save RhSi_WSOC_ftn58sparse_ver3.mat ftn58sparse
